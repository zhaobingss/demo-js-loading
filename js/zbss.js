var zbss = {
	maskShow:function(content, time){
		zbss.maskHide();
		
		$("body").append('<div class="zbss-mask" style="display: none; "></div>');
		$("body").append('<div class="zbss-mask-content" style="display: none; ">'+content+'</div>');
		
		var mask = $(".zbss-mask");
		var mask_content = $(".zbss-mask-content");
